...
function Successor.GetColorForScore(score)
...
function Successor.GetColorNameForScore(score)
    if not score or score <= 0 then
        return "Grey"
...
function Successor.GetPercentileTier(percentile)
...
function Successor.GetWoWQualityColor(quality)
...
function Successor.HSVToRGB(h, s, v)
    local r, g, b
...
function Successor.GetGradientColor(score, minScore, maxScore)
    local normalized = 0
